...
5. CRÍTICO: Si proporcionas información turística sobre un lugar o atracción, DEBES incluir SIEMPRE la URL o enlace web oficial, si está disponible en el contexto. No esperes a que el usuario te lo pida. Intégralo naturalmente en la descripción.
...
def llamar_groq(mensajes: list, max_tokens: int = 1500) -> str:
    ...
    try:
        ...
        return json.dumps({
            "mensaje": f"Lo siento, hubo un error de conexión: {str(e)}. Por favor, verifica tu API Key.",
            "acciones": [],
            "error": str(e)
        })
