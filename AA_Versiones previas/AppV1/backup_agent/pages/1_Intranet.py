...
def render_sidebar_agent():
    """
    Renderiza el agente en la barra lateral con branding de THE VALLEY.
    """
    with st.sidebar:
        # BRANDING THE VALLEY
        st.markdown("""
        <style>
            /* Contenedor del sidebar específico para Branding The Valley */
            ...
            .valley-brand {
                ...
                padding: 1rem 0;
                text-align: center;
                border-bottom: 2px solid #663399; /* Morado The Valley */
                margin-bottom: 1rem;
            }
            .valley-title {
                font-weight: 800;
        ...
        <div class="valley-brand">
            <div class="valley-title">THE VALLEY</div>
            <div class="valley-subtitle">INTELLIGENCE AGENT</div>
        </div>
        """, unsafe_allow_html=True)
